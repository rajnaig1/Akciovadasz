    ...
    <td><span  id="{{ $shoppingCart->id }}_amount">{{ $shoppingCart->amount}}</span> <span id="{{ $shoppingCart->id }}_quantity">{{ $shoppingCart->quantity}}</span></td>
    <td><span id="{{ $shoppingCart->id }}_price">{{$shoppingCart->price}}</span> Ft</td>
    <td id="{{ $shoppingCart->id }}_comment">{{$shoppingCart->comment}}</td>
    <td><span id="{{ $shoppingCart->id }}_offerBegin">{{$shoppingCart->offerBegin}}</span>-tól <span  id="{{ $shoppingCart->id }}_offerEnd">{{$shoppingCart->offerEnd}}</span>-ig</td>

    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center" style="padding: 0;">
            <div class="card text-center">
                ...
                <div class="card-body text-center" style=" padding-left:0rem;padding-right: 0rem; margin-right:0rem;">
                    <div class=" d-flex justify-content-center align-items-center text-center" style="padding-top: 0.5rem; margin-rigth:1rem;">

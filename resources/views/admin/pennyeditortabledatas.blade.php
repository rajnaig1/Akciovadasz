...
<tr>
    <td><button id="{{ $product->id }}"class="btn btn-primary modalToggler" data-bs-toggle="modal" data-bs-target="#editModal">Szerkesztés</button></td> 
    <td><button class="btn btn-danger modalDeleteToggler" data-bs-toggle="modal" id="{{ $product->id }}" data-bs-target="#deleteModal">Törlés</button></td>

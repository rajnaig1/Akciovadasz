...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped text-center">
            <thead>
                ...
                <th class="sorting" data-sorting_type="asc" data-column_name="price" scope="col">price<span
                        id="price_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="unitLong" scope="col">unitlong<span
                        id="unitLong_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="unitPrice" scope="col">unitPrice<span
                        id="unitPrice_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="unitShort" scope="col">unitshort<span
                        id="unitShort_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="priceScore" scope="col">priceScore<span
                        id="priceScore_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="volumeLabelLong" scope="col">
                    volumeLabelong<span id="volumeLabelLong_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="product_ident_id" scope="col">
                    product_ident_id<span id="product_ident_id_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="product_ident_name" scope="col">
                    product_ident name<span id="product_ident_name_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="Category" scope="col">category<span
                        id="Category_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="validityStart" scope="col">
                    validityStart<span id="validityStart_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="validityEnd" scope="col">validityEnd<span
                        id="validityEnd_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="isPublished" scope="col">isPublished<span
                        id="isPublished_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="weight" scope="col">weight<span
                        id="weight_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="productMarketing" scope="col">
                    productMarketing<span id="productMarketing_icon"></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="images" scope="col">productImage<span
                        id="images_icon"></span></th>
            </thead>
            <tbody>
    ...
    <x-login-register-component class="nav-link-active" buttonText="Szerkesztés" id="editModal"
        title="Termék szerkesztése" body="" url="/admin/updatepennyproduct" method="POST">
        @method('PUT')
        <div class="text-center d-grid gap-2">
            ...
            <input type="date" class="form-control" placeholder="Akció kezdete" id="modalEditValidityStart"
                name="validityStart" required>
            <strong>Akció vége:</strong>
            <input type="date" class="form-control" placeholder="Akció vége" id="modalEditValidityEnd"
                name="validityEnd" required>
    ...
    <x-login-register-component class="nav-link-active" buttonText="Törlés" id="deleteModal" title="Termék törlése"
        body="Biztosan törölni akarja a terméket?" url="/admin/deletepennyproduct" method="POST">
        @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "/admin/getpennydatas/fetchdata?page=" + page + "&sortby=" + sort_by +

...
<nav class="navbar navbar-expand-lg navbar-light bg-light text-center sticky-top">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 m-auto">
          ...
          @guest
          <li class="nav-item">   
            <a class="nav-link" data-bs-toggle="modal" aria-current="page" href="#loginModal">Bejelentkezés</a>
          </li>
          <li class="nav-item">   
            <a class="nav-link" data-bs-toggle="modal" aria-current="page" href="#registerModal">Regisztráció</a>
          </li>
          @else
          <li class="nav-item">   
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{ url('/admin/getpennydatas') }}">Penny Termékek</a>
          </li>
          @endif
  ...
  <x-login-register-component class="nav-link-active" buttonText="Regisztráció" id="registerModal" title="REGISZTRÁCIÓ" body="" url="/register" method="POST">
    ...
    <input type="text" class="form-control" name="name" placeholder="Név" required style="margin-bottom: 10px;">
    
    <input type="email" class="form-control" name="email" placeholder="E-Mail" required style="margin-bottom: 10px;">
    
    <input type="text" class="form-control" name="password" placeholder="Jelszó" required style="margin-bottom: 10px;">

    <input type="text" class="form-control" name="password_confirmation" placeholder="Jelszó Mégegyszer" required style="margin-bottom: 10px;">
